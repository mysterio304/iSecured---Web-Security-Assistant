    ...
    <div class="wrapper">
        ...
        <div class="main p-3">
            <div class="container d-flex justify-content-center">
                <!-- LEFT BOX -->
                <div class="col-md-6 d-flex justify-content-center flex-column left-box">
                    <h1>ABOUT US</h1>
                    <h3>Empowering You to Stay Safe Online</h3>
                    <p>In a world full of cyber threats, staying secure is more important than ever. Our mission is simple: to help you protect yourself from phishing scams, AI-driven fraud, and weak passwords.</p>
                    <small>Developed by Dauren Kontayev, 2025</small>
                </div>
